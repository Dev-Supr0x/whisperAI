...
export const DashboardTrial = () => {
    ...
    return (
        <div className="border border-border/10 rounded-lg w-full bg-white/5 flex-col gap-y-2">
          ...
          <Button
             className="bg-transparent border-t border-border/10 hover:bg-white/10 rounded-t-none items-center"
             asChild
          >
            <Link href="/upgrade">
              Upgrade 
